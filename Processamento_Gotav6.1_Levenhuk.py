...
label_1=tk.Label(window, text = "Hanging Droplet software", font = times20).grid(row=0,column=1,columnspan=3)

label_directory = tk.Label(window, text = "Choose work directory:").grid(row=1,column=1)
button_directory = tk.Button(window,text="Choose Directory",command = choose_directory).grid(row=1,column=3)

label_entry_ensaio = tk.Label(window, text = "Choose number of photos:").grid(row=2,column=1)
entry_ensaio = tk.Entry(window)
entry_ensaio.grid(row=2,column=3)

label_start = tk.Label(window, text = "Start processing:").grid(row=5,column=1)
button_start = tk.Button(window,text="Start",command = main).grid(row=5,column=3)

button = tk.Button(window, text="Quit", command = close_window).grid(row=7,column=2)

window.grid_rowconfigure((1,2,3,4,5,6,7,8), weight=1)
